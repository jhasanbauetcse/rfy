...
// NEW: Event listener for maintenance list
...
// NEW: Function to open and populate maintenance details modal
...
// NEW: Event listener for closing maintenance modal
$("#cancelUpdateMaintenanceBtn").addEventListener("click", () => {
  maintenanceDetailsModal.close();
});

// NEW: Event listener for saving maintenance updates
